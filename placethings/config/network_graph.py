...
def _gen_edge_info(device_inventory, device, nw_inventory, nw_device, ):
...
def _create_default_edge_info():
    ...
    edges = _gen_edge_info(device_inventory, device, nw_inventory, nw_device)
